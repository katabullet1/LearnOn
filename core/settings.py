...
DATABASES = {
    'default': {
        ...
        'NAME': "takeone", #'test1',
        'USER': "divine", #'postgres',
        'PASSWORD':"learnon2024", # os.getenv("POSTGRES_PASSWORD"), 
        'HOST': "database-2.chmw2oys67t3.eu-north-1.rds.amazonaws.com", #'localhost', 
        'PORT': '5432',
        }
    }
from decouple import config
#consumer_key = config('POSTGRES_PASSWORD')
sho=str(os.getenv('POSTGRES_PASSWORD'))
#print (os.environ)
import dotenv
#consumer_key = config("POSTGRES_PASSWORD")
dotenv.load_dotenv()
conf=os.getenv("virtualenv")
